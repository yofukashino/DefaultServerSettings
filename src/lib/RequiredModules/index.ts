...
const ModuleNames = ["GuildSettingUtils", "GuildVerificationUtils", "NicknameUtils"] as const;
...
export const { GuildSettingUtils, GuildVerificationUtils, NicknameUtils } = Modules.Proxy;
